...
Original file is located at
    https://colab.research.google.com/drive/1y0zVbLk9kwe0M6w2DwWAtr9X3AFGpvf0
"""
...
BC_water = files.upload()
print("File Uploaded")

import io
df_BC = pd.read_csv(io.BytesIO(BC_water['BC_waterlevels.csv']))
...
# Add title
plt.title("Water Levels and Recommended Level for British Columbia for the past 89 days from today", color = 'blue')
...
# limits
plt.ylim(top = 29.85)
plt.ylim(bottom = 29.2)

# Line chart 
sns.lineplot(data=df_BC)
