...
Original file is located at
    https://colab.research.google.com/drive/1DIl2MPjo_CdACNNyFi7eBQodzrk0Ktmb
"""
...
QC_water = files.upload()
print("File Uploaded")

import io
df_QC = pd.read_csv(io.BytesIO(QC_water['QC_waterlevels.csv']))
...
plt.axhline(y=208.0936, color="#4682B4", linewidth = 0.6)

# Add title
plt.title("Water Levels and Recommended Level for Quebec for the past 89 days from today", color = 'blue')
...
# limits
plt.ylim(top = 208.11)
plt.ylim(bottom = 207.89)

# Line chart 
sns.lineplot(data=df_QC)
