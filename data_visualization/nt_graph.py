...
Original file is located at
    https://colab.research.google.com/drive/1wkzUwq8O1N2AAd_DJ8Dpvu4qaI9OL3Cf
"""
...
NT_water = files.upload()
print("File Uploaded")

import io
df_NT = pd.read_csv(io.BytesIO(NT_water['NT_waterlevels.csv']))
...
plt.axhline(y=2.076, color="#4682B4", linewidth = 0.6)

# Add title
plt.title("Water Levels and Recommended Level for Northwest Territories for the past 89 days from today", color = 'blue')
