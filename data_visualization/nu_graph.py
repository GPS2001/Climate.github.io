...
Original file is located at
    https://colab.research.google.com/drive/1MFPJDKmetmoh6bL66-xGbi38ZmvdeEGv
...
NU_water = files.upload()
print("File Uploaded")

import io
df_NU = pd.read_csv(io.BytesIO(NU_water['NU_waterlevels.csv']))
...
plt.axhline(y=14.0564, color="#4682B4", linewidth = 0.6)

# Add title
plt.title("Water Levels and Recommended Level for Nunavut for the past 89 days from today", color = 'blue')
...
# limits
plt.ylim(top = 14.07)
plt.ylim(bottom = 13.98)

# Line chart 
sns.lineplot(data=df_NU)
