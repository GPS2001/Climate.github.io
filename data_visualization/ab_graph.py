...
Original file is located at
    https://colab.research.google.com/drive/17po68psJjRSArtN97VJ-i1ow_84pPDt5
...
AB_water = files.upload()
print("File Uploaded")

import io
df_AB = pd.read_csv(io.BytesIO(AB_water['AB_waterlevels.csv']))
...
# Add title
plt.title("Water Levels and Recommended Level for Alberta for the past 89 days from today", color = 'blue')
