...
Original file is located at
    https://colab.research.google.com/drive/15f9s0G6gxGD2MN3LS_46CIXLfnZ9x3uY
...
NB_water = files.upload()
print("File Uploaded")

import io
df_NB = pd.read_csv(io.BytesIO(NB_water['NB_waterlevels.csv']))
...
arr = np.array([24, 48, 72, 96, 120, 144, 168, 192, 216, 240, 264, 288, 312, 336,
                ...
                2040, 2064, 2088, 2112, 2136, 2160, 2184])

for a in range(91):
  var = arr[a];
  plt.axvline(x = var, color ='lightblue', linewidth = 0.5)

plt.axhline(y=2.764, color="#4682B4", linewidth = 0.6)

# Add title
plt.title("Water Levels and Recommended Level for New Brunswick for the past 90 days from today", color = 'blue')
...
# limits
plt.ylim(top = 2.77)
plt.ylim(bottom = 2.37)

# Line chart 
sns.lineplot(data=df_NB)
