...
Original file is located at
    https://colab.research.google.com/drive/1kHS-hBl8wDC_365DjClG1eqgfYosvmqG
"""
...
SK_water = files.upload()
print("File Uploaded")

import io
df_SK = pd.read_csv(io.BytesIO(SK_water['SK_waterlevels.csv']))
...
plt.axhline(y=1186.521, color="#4682B4", linewidth = 0.6)

# Add title
plt.title("Water Levels and Recommended Level for Saskatchewan for the past 90 days from today", color = 'blue')
...
# limits
plt.ylim(top = 1186.53)
plt.ylim(bottom = 1186.47)

# Line chart 
sns.lineplot(data=df_SK)
